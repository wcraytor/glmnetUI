...
Configure report fields (appraiser name, property address, report date, file number) and export to Word (.docx) or PDF. See Chapter 12.
...
- Per-variable contribution plots
